...
_all_regions = ['North', 'South', 'Des', 'South_ngc', 'South_sgc', 'South_all', 'South_mid', 'South_mid_ngc', 'South_mid_sgc', 'South_pole', 'South_mid_no_des', 'Des_mid']
...
def _get_feature_names(tracer=None, use_stream=None, use_stars=None, feature_names=None):
    ...
    elif tracer in ['BGS', 'BGS_ANY']:
        to_remove = ['PSFDEPTH_W1', 'PSFDEPTH_W2']
    elif tracer in ['BGS_FAINT', 'BGS_BRIGHT']:
        to_remove = ['PSFDEPTH_W2']
...
def _get_nfold_params(params=None, regions=None):
    ...
    """
    default = _format_regressor_params({'North': 6, 'South': 12, 'Des': 6, 'South_ngc': 7, 'South_sgc': 5, 'South_all': 18, 'South_mid': 14, 'South_mid_ngc': 7, 'South_mid_sgc': 7, 'South_pole': 5, 'Des_mid': 3}, regions=regions)
    utils.deep_update(default, _format_regressor_params(params or {}, regions=regions))
    return default
...
class Regression(object):
    ...
    def get_weight(self, save=False, savedir=None):
        ...
        weight = PhotoWeight(sys_weight_map=w, regions=self.dataframe.regions, 
                             ...
                             mean_density_region=self.dataframe.mean_density_region, fracarea=self.dataframe.fracarea,)
